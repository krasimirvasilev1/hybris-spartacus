...
public class SecurePortalBeforeControllerHandlerTest
{
			...
			throws Exception
	{
		...
		// WHEN-THEN
		assertEquals(false, beforeControllerHandler.beforeController(request, response, handler));
	...
	public void givenLoginRequestAndUserIsAnonymous_WhenBeforeControllerIsCalled_ThenItReturnsTrue() throws Exception
	{
		...
		// WHEN-THEN
		assertEquals(true, beforeControllerHandler.beforeController(request, response, handler));
	}
